...
@section('content')
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="mx-auto max-w-2xl rounded-xl bg-white p-8 shadow-xl ring-1 ring-gray-200">
            <h1 class="mb-8 text-center text-3xl font-bold text-gray-800">Modifier la Paiement</h1>
            ...
            <form action="{{ route('payment.update', $payment->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="pt-2">
                    <label for="copy" class="mb-2 block text-sm font-medium text-gray-700">Modifier la Copie
                        (Image/pdf)</label>
